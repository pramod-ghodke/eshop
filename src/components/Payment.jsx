  ...
  return (
    <>
      <Container className="mt-3">
        ...
        <Row className="mt-4 flex-column-reverse flex-md-row">
          <Col md={6}>
          <Button className="btn-back"><Icon.ArrowLeft className="me-2"/>Back</Button>
          </Col>

          <Col className='text-md-end text-center mb-3 mb-md-0' md={6}>
          <Button className="btn-continue me-3">CONTINUE SHOPPING</Button>
